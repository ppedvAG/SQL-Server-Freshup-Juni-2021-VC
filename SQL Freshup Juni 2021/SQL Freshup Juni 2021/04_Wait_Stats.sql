...
--QUEUE (FIFO)--> RESSOURCEN --> PROZESSOR

----------------------------70ms----100ms! Abfrageausführung(RUNNING)

--wait_time_ms = 100ms
--signal_time_ms: Anteil der CPU (< 25%), bei > 25% CPU Engpass
--Wait_time-Signal_time = Wartezeit auf Ressource

--CXPACKET

--Zeiten sind kummulierend seit Neustart des SQL Serve´r
--Problem keine AHnung wann wie was?

--Idee: regelm Werte wegschreiben
