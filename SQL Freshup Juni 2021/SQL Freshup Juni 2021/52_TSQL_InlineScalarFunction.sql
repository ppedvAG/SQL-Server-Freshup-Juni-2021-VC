...
update ku4 set freight = freight * RAND(convert(varbinary, newid()))*100
select freight, count(*) from ku4 group by freight

select * from ku4 where dbo.fbrutto(freight,1.19) < 2
