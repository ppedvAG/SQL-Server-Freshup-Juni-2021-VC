...
declare @vlfcounts table  
 ...
 --Model Einfach wählen (Vorsicht: TX werden aus dem Log gelöscht.. 
	--hätten gesichert werden können)
 --Log verkleinern
 --Ideale Startgörße eingeben (25% der Daten).. Wachstumsrate hoch wählen (bis 1000MB)
 --Model Vollständig und eine VOLLBACKUP
